...
export const initialContent: ContentData = {
    ...
    sections: {
        ...
        contactForm: {
            ...
            phoneLabel: "연락처 *",
            messageLabel: "문의 내용 *",
            privacyTitle: "상담 문의 서비스 제공에 따른 개인정보 수집이용 동의서",
            privacyContent: "■개인정보 수집목적\nㄴ소식 관련 이메일 및 문자 발송\nㄴ솔루션 소개 및 컨설팅 정보 제공\n\n■개인정보 수집항목\nㄴ이름, 소속, 이메일, 기타 문의 사항\n\n■개인정보 보유기간\nㄴ 수집 후 1년\n\n위와 같이 개인정보를 제공하는데 동의를 거부할 권리가 있습니다. 다만, 동의를 거부하는 경우 상담 서비스를 제한 받으실 수 있으실 수 있습니다.",
            privacyAgreeLabel: "동의함",
            privacyDisagreeLabel: "동의하지 않음",
